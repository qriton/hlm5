...
\twocolumn[%
\begin{center}
{\LARGE\bfseries Certified Knowledge Editing: Closed-Form Reachability\\
 Guarantees for Additive Edits to a Frozen Language Model\par}
\vspace{0.6em}
{\large Marius Dima \quad Qriton \quad \texttt{marius.dima@qriton.com}\par}
\vspace{1.2em}
\end{center}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig1-pipeline-a-b.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-head-geometry.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig-arch-forward.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-reachability-geometry.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig-envelope-multikey.pdf}
...
under the heuristic $\beta=1.05L+1$ to $18.5$ at $\beta^{\star}\approx73$---a
$17\times$ improvement in median worst-case margin at identical compute
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-betastar.pdf}
...
peak ($\beta^{\star}\approx73$, worst-case margin $18.5$) and the heuristic
margin ($1.08$ at $\beta=1.05L+1$, giving the $\approx17\times$ gain) are
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-gate-selectivity.pdf}
...
\midrule
HLM5 ($1$B, deployed $\tau{=}0.95$, certificate-dosed, $17$ facts) & $0.765$ ($13/17$) {\scriptsize$[0.52,0.95]$} & $0.020$ {\scriptsize$[0.00,0.06]$} & $0$ changes ($1.000$ {\scriptsize$[1.00,1.00]$}) & forget exact$^{\ddagger}$ & $0$ \\
HLM5 ($1$B, deployed, $+$ synthesis rescue) & $1.000$ ($17/17$) {\scriptsize$[1.00,1.00]$} & $0.020$ {\scriptsize$[0.00,0.06]$} & $0$ changes ($1.000$ {\scriptsize$[1.00,1.00]$}) & forget exact$^{\ddagger}$ & $0$ \\
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-notax-delta.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig-frontier.pdf}
...
misclassification), and residual synthesis (\S\ref{sec:synth}) rescues those
four ($1.000$, $17/17$). Two conclusions follow. First, the additive read's
...
pipeline \emph{matches} the gate-matched logit bias on every axis measured here
(efficacy $1.000$, generalization $0.020$, locality $1.000$): the mechanism's
remaining value over the simplest certifiable variant is the a-priori admission
test, the certified dose, the synthesis rescue, and the audit trail---and,
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig-certdosed.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/fig-certpredict.pdf}
...
\midrule
HLM5, certificate-dosed ($\beta^{\star}$) & $0.765$ ($13/17$) {\scriptsize$[0.52,0.95]$} & $0.020$ {\scriptsize$[0.00,0.06]$} & $1.000$ {\scriptsize$[1.00,1.00]$} \\
HLM5, certificate-dosed $+$ synthesis & $1.000$ ($17/17$) {\scriptsize$[1.00,1.00]$} & $0.020$ {\scriptsize$[0.00,0.06]$} & $1.000$ {\scriptsize$[1.00,1.00]$} \\
...
synthesis rescues the four certified-unreachable facts ($17/17$); the global
...
\begin{itemize}
  ...
  \item \textbf{E7: scale.} Repeat the gates, operating envelope, and certificate
  at $3$B. \emph{Pass:} the certificate's
  predictive accuracy and the no-tax result hold at $3$B.
