"""Emit the formal fail-closed E8 full-path verdict."""
...
def main() -> int:
    if VERDICT_PATH.exists():
        raise FileExistsError(f"E8 verdict already exists: {VERDICT_PATH}")
    ...
    if not RESULT_PATH.is_file():
        ...
        if validity_failures:
            ...
            verdict_name = "FAIL_3B_FULL_PATH_ZCA"
            exit_code = 0
        else:
            verdict_name = "PASS_3B_FULL_PATH_ZCA"
            exit_code = 0
