"""Emit the formal fail-closed HLM5 E10 verdict."""
...
def main() -> int:
    if VERDICT_PATH.exists():
        raise FileExistsError(f"E10 verdict already exists: {VERDICT_PATH}")
    validity: list[str] = []
    ...
    if not RESULT_PATH.is_file():
        ...
        if validity:
            ...
            verdict, exit_code = "FAIL_3B_CAPACITY_1024", 0
        else:
            verdict, exit_code = "PASS_3B_CAPACITY_1024", 0
