"""Emit the formal fail-closed E7c ZCA geometry verdict."""
...
def main() -> int:
    if VERDICT_PATH.exists():
        raise FileExistsError(f"E7c verdict already exists: {VERDICT_PATH}")
    ...
    if not RESULT_PATH.is_file():
        ...
        if validity_failures:
            ...
            verdict_name = "FAIL_3B_ZCA_GEOMETRY"
            exit_code = 0
        else:
            verdict_name = "PASS_3B_ZCA_GEOMETRY"
            exit_code = 0
